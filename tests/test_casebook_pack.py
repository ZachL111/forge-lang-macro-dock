"""Regression checks for the forge-lang-macro-dock casebook."""
...
from casebook.harness import assert_expected, forge_lang_macro_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(forge_lang_macro_dock_summary(), assert_expected())
