...
`forge-lang-macro-dock` is centered on compilers work in Julia. The technical target is: Create a Julia reference implementation for macro workflows, centered on storage recovery, log and snapshot fixtures, and replay consistency checks.
...
The score is deterministic. The current threshold is 161. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 5.
